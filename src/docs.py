...
![Image04](assets/doc04.png)

![Image05](assets/doc05.png)

追加されたオブジェクトをクリックすることでオブジェクト内にテキストを入力することができます。  

![Image06](assets/doc06.png)

コントロールバーからペンのアイコンを選択すると、ボード上にお描きすることができます。  

![Image07](assets/doc07.png)
...
"""
    ...
    def resize(self, e):
        self.doc.width = e.width
        self.doc.height = e.height
        self.doc.update()
